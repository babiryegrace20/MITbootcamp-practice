...
class Point(object):
    ...
    def __init__(self, x, y):
        ...
        self._y = y
        # secret ID to differentiate between newly created Points
        # and copies of an original
        self.ID = "_".join(map(str, [time.time(), x, y]))
        # True if this point was created using "Point(...)" or was
        # copied from such a point
